...
<div class="context">
	<form
		action="<%=request.getContextPath()%>/adminClassAdd.action"
		...
		<table>
			...
			<tr>
						...
						<tr>
						<td>班主任：</td>
						<td><input type="text" class="form-control" name="tea_number" placeholder="请输入班主任编号"
							id="tea_number" /></td>
					</tr>
			<tr>
				<td></td>
				<td><button type="submit" class="btn btn-primary">创&nbsp;建</button></td>
			</tr>
		</table>
		</center>
	</form>
