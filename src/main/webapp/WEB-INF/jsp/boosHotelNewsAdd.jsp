...
 </script>
<div class="context">
<form name="myForm" method="post" action="<%=request.getContextPath()%>/newsHotelAdd.action">
	<center>
	<span>宿舍新闻的发布</span>
	...
	function requestParm()
	{
		...
		{
		type:"POST",
		url:"newsHotelAdd.action",
		data:{new_home:document.getElementById("new_home").value,new_author:document.getElementById("new_author").value,new_context:document.getElementById("new_context").value,new_college:document.getElementById("new_college").value,new_major:document.getElementById("new_major").value,new_class:document.getElementById("new_class").value,new_flag:"2"},
		dataType:"json",
		}		
		)
		}
